  ...
  return (
    <div className="modal">
      <div className="modal-closeButton">
        <button className="modal-closeButton-button" onClick={props.close}>x</button>
      </div>
      <div className="modal-contents">
        <div className="modal-contents-first">
          <label className="modal-contents-first-label">학과전공</label>
          <select className="modal-contents-first-select">
        ...
        <div className="modal-contents-second">
          ...
          <input className="modal-contents-second-input"></input>
        </div>
        <div className="modal-contents-third">
          <div className="modal-contents-third-prof">
            ...
            <input className="modal-contents-third-prof-input"></input>
          </div>
          <div className="modal-contents-third-type">
            <label className="modal-contents-third-type-label">이수구분</label>
            <select className="modal-contents-third-type-select">
              <option value="test">test</option>
              <option value="test">test</option>
            </select>
          </div>
          <button className="modal-contents-third-button">조회</button>
        </div>
      </div>
    </div>
  );
